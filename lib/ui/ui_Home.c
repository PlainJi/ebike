...
void ui_Home_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Label_Number5, 25);
    ...
    lv_obj_add_flag(ui_Label_Number5, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    ui_Image_Battery_icon = lv_img_create(ui_Group_Battery_Percent);
    ...
    lv_obj_set_x(ui_Image_Battery_icon, 26);
    lv_obj_set_y(ui_Image_Battery_icon, 187);
    lv_obj_set_align(ui_Image_Battery_icon, LV_ALIGN_TOP_MID);
    ...
    ui_Label_Time_Home = lv_label_create(ui_Head_Group1);
    lv_obj_set_width(ui_Label_Time_Home, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label_Time_Home, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_height(ui_Label_SpeedX, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label_SpeedX, -4);
    lv_obj_set_y(ui_Label_SpeedX, 0);
    lv_obj_set_align(ui_Label_SpeedX, LV_ALIGN_LEFT_MID);
    lv_label_set_text(ui_Label_SpeedX, "SpeedX");
    ...
    ui_Label_Temp = lv_label_create(ui_Group_Footer);
    lv_obj_set_width(ui_Label_Temp, 29);
    ...
    lv_obj_set_style_text_font(ui_Label_Temp, &ui_font_Big, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label_Temp_Celsius = lv_label_create(ui_Group_Footer);
    lv_obj_set_width(ui_Label_Temp_Celsius, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label_Temp_Celsius, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label_Temp_Celsius, -426);
    lv_obj_set_y(ui_Label_Temp_Celsius, 5);
    lv_obj_set_align(ui_Label_Temp_Celsius, LV_ALIGN_RIGHT_MID);
    lv_label_set_text(ui_Label_Temp_Celsius, "°C");
    lv_obj_set_style_text_color(ui_Label_Temp_Celsius, lv_color_hex(0x94AEB4), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label_Temp_Celsius, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label_Temp_Celsius, &ui_font_Medium, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label_Humidity = lv_label_create(ui_Group_Footer);
    ...
    lv_obj_set_style_text_font(ui_Label_Humidity, &ui_font_Big, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label_Humidity_Percent = lv_label_create(ui_Group_Footer);
    lv_obj_set_width(ui_Label_Humidity_Percent, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label_Humidity_Percent, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label_Humidity_Percent, 84);
    lv_obj_set_y(ui_Label_Humidity_Percent, 5);
    lv_obj_set_align(ui_Label_Humidity_Percent, LV_ALIGN_LEFT_MID);
    lv_label_set_text(ui_Label_Humidity_Percent, "%");
    lv_obj_set_style_text_color(ui_Label_Humidity_Percent, lv_color_hex(0x94AEB4), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label_Humidity_Percent, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label_Humidity_Percent, &ui_font_Medium, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Group_ODO, 54);
    lv_obj_set_y(ui_Group_ODO, 84);
    ...
    ui_Group_AT = lv_obj_create(ui_Group_Content);
    lv_obj_set_width(ui_Group_AT, 80);
    lv_obj_set_height(ui_Group_AT, 40);
    lv_obj_set_x(ui_Group_AT, 1);
    lv_obj_set_y(ui_Group_AT, -1);
    lv_obj_set_align(ui_Group_AT, LV_ALIGN_BOTTOM_RIGHT);
    lv_obj_clear_flag(ui_Group_AT, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_Group_AT, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Group_AT, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui_Group_AT, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_Group_AT, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_Group_AT, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_Group_AT, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label_Trip_Time = lv_label_create(ui_Group_AT);
    lv_obj_set_width(ui_Label_Trip_Time, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label_Trip_Time, LV_SIZE_CONTENT);    /// 1
    lv_label_set_text(ui_Label_Trip_Time, "AT");
    lv_obj_set_style_text_color(ui_Label_Trip_Time, lv_color_hex(0x94AEB4), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label_Trip_Time, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Label_Trip_Time, &ui_font_Small, LV_PART_MAIN | LV_STATE_DEFAULT);
